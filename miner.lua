...
---------------------------------------------------------------------
-- COLLECT COMMAND LINE ARGUMENTS (MOVED HERE TO FIX LINE 89 ERROR)
---------------------------------------------------------------------
...
if args[1] == "inventory" then
  ...
  if junk_items > 0 then
    ...
    -- manageJunk() -- Will be called later when function is defined
...
if args[1] == "dimension" then
  ...
  print("Dimension switched to: " .. new_dimension)
...
-- Call main with the already-defined args
main(args)